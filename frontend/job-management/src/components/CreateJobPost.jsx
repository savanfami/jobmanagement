...
export const CreateJobPost = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert("Something went wrong while submitting the job post.");
    }
  };
    ...
    <div className="w-full">
      ...
      {errors.maxSalary && (
        ...
        <div className="flex justify-between">
          ...
          <button
            type="submit"
            className="bg-blue-500 text-white rounded-md py-2 px-8 flex items-center gap-2 hover:bg-blue-600"
          >
            Publish
